...
Notice: New categories might appeared in a new partition or same old categories are deprecated
...
Optional multiplier part specifying how many times to replicate each observation to get the population approximation.
...
This additional weights do not change anything from the perspective of modelling, as it is replicated for each observation too.
