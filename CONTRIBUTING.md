...
Contributions to `cat2cat` are welcome! Please read this documentation
before proceeding.
...
Though note that private discussions over email don’t help others
because of the lack of transparency - of course email is totally
warranted if it’s a sensitive problem of any kind.
